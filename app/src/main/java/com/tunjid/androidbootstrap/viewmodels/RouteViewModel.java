...
public class RouteViewModel extends AndroidViewModel {
    ...
    public RouteViewModel(@NonNull Application application) {
        ...
        routes = Arrays.asList(
                ...
                new Route(ShiftingTileFragment.class.getSimpleName(), formatRoute(R.string.route_shifting_tile)),
                new Route(EndlessTileFragment.class.getSimpleName(), formatRoute(R.string.route_endless_tile)),
