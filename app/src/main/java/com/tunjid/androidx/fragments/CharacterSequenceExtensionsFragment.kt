    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.text).apply {
            ...
            text = SpannableStringBuilder()
                    ...
                    .append("\n")
                    .append("8. This is a superscript span".superScript())
                    .append("\n")
                    .append("9. This is a subscript span".subScript())
                    .append("\n")
                    .append("10. This is a background colored span".backgroundColor(context.themeColorAt(R.attr.prominent_text_color)))
                    .append("\n")
